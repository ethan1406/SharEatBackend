    ...
    render() {
        ...
        <div className="container">
            ...
            <div className="form-group">
                    ...
                    <button id="registerButton" style={{display:"block"}} className="col-sm-2 col-sm-offset-5 btn btn-success">Register</button>
                    <button id = 'loginBtn' style={{display:"block", marginTop: "10px"}} className="col-sm-2 col-sm-offset-5  btn btn-danger">Login</button>
            </div>
        </div>
        );
    }
